...
set term png font "/Library/Fonts/Microsoft/Arial.ttf" 18 size 1000, 500
#//set yrange [-.5:1]
reset
#set output ""
...
#set grid
unset grid
#set title "Relative L^2-L^2 error, T = 10, tau = .0001, eta = 1, k = 1 (KdV)"
...
set output "Food-Mass.png"
#set xlabel "x"
#set ylabel "Miura transform of solution to mKdv"

#set xrange [-30:20]
plot "Mass.txt" using 7:4 w l lw 3 tit ""
